...
def compo_detection(input_img_path, output_root, uied_params,
    ...
    det.rm_line(binary, show=False, wait_key=wai_key)
    ...
    Compo.compos_update(uicompos, org.shape)
    draw.draw_bounding_box(org, uicompos, show=False, name='merged compo', write_path=pjoin(ip_root, name + '.jpg'), wait_key=wai_key)
    ...
    #     draw.draw_bounding_box_class(org, uicompos, show=False)
    #     uicompos = det.rm_noise_in_large_img(uicompos, org)
    #     draw.draw_bounding_box_class(org, uicompos, show=False)
    #     det.detect_compos_in_img(uicompos, binary_org, org)
    #     draw.draw_bounding_box(org, uicompos, show=False)
    # if classifier is not None:
    ...
    #     draw.draw_bounding_box_class(org, uicompos, show=False, name='cls', write_path=pjoin(ip_root, 'result.jpg'))
